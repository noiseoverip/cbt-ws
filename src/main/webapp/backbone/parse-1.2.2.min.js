(function (e) {
   ...
   t.serverURL = "https://api.parse.com", t.initialize = function (e, n) {
      ...
      var o = new t.Promise, u = new XDomainRequest;
   ...
   t.Object = function (e, r) {
      ...
      var r = n.uniq(t.Object._findUnsavedChildren(e)), i = n.uniq(r);
      return t.Promise._continueWhile(function () {
         ...
         return n.each(e, function (e) {
            ...
            return t._request("batch", null, null, "POST", {requests: n.map(e, function (e) {
               var t = e._getSaveJSON(), n = "POST", r = "/1/classes/" + e.className;

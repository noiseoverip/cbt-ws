...
public class CbtJerseyServletModule extends JerseyServletModule {
	...
	protected void configureServlets() {				
		...
		paramsSecure.put("com.sun.jersey.config.property.packages","com.cbt.ws.services;org.codehaus.jackson.jaxrs"); // scan for resources
        ...
        paramsPublic.put("com.sun.jersey.config.property.packages","com.cbt.ws.services;org.codehaus.jackson.jaxrs"); // scan for resources
		//params.put("com.sun.jersey.config.property.packages","com.cbt.ws.services");
